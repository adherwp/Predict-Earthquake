...
def sort_list(waktu, magnitudo):
    waktu_strp = list()
    for x in range(len(waktu)):
        try:
            FMT = '%H:%M:%S'
            waktu_strp.append(datetime.strptime(waktu[x], FMT))
        except:
            FMT = '%H:%M'
            waktu_strp.append(datetime.strptime(waktu[x], FMT))
...
def main_predict_t(waktu_asc, magnitudo_asc, network, minmax):
    # print('--------------')
    # waktu_asc, magnitudo_asc = sort_list(waktu, magnitudo)
    print(waktu_asc)
    print(magnitudo_asc)
...
# time = [Timestamp('1900-01-01 01:01:01'), Timestamp('1900-01-01 01:01:02'), Timestamp('1900-01-01 01:01:03'), Timestamp('1900-01-01 01:01:04'), Timestamp('1900-01-01 01:01:05'), Timestamp('1900-01-01 01:01:06'), Timestamp('1900-01-01 01:01:07'), Timestamp('1900-01-01 01:01:08'), Timestamp('1900-01-01 01:01:09'), Timestamp('1900-01-01 01:01:10'), Timestamp('1900-01-01 01:01:11'), Timestamp('1900-01-01 01:01:12'), Timestamp('1900-01-01 01:01:13'), Timestamp('1900-01-01 01:01:14')]
mag = [5.0, 4.0, 3.9, 7.0, 5.0, 3.8, 3.7, 3.5, 3.5, 3.3, 3.3, 4.5, 4.4, 3.0]
# net =
mm = [[0.0, 115.35], [2.323076923076923, 4.276923076923077], [0.009840854382011965, 3668.922173063225], [2.258331305879992, 12.350249329031293], [0.13157476524919368, 0.7195494974565273], [0.7999999999999998, 4.199999999999999], [0.054730584300467414, 0.3415841584158412], [0.0, 8.0]]
# main_predict_t(time, mag, net, mm)